...
The final protocol and framework proves to be an intelligent solution to share OG data over a wireless adhoc network. Although not the most efficient solution, it provides a framework for further development into sharing and increase in efficiency.
\end{abstract}