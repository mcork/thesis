...
Next I would like to thank my Supervisors Mr Michael Woods and Dr Jose Guivant for their support and ideas to help me in completion of my Thesis.\newline
I was like to thank Matthew Grosvenor for putting up with all my networking questions.\newline
...
\item created a network manager to intelligent share the OG data over an wireless adhoc network.
\end{itemize}
This will involve implementing a way to share data from programs that will create and manipulate the data to other programs that need the data and then using the network manager to communicate it over the network. 
